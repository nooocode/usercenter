...
func (c *userClient) UpdateProfile(ctx context.Context, in *UserProfile, opts ...grpc.CallOption) (*CommonResponse, common.ErrorWithAttachment) {
	out := new(CommonResponse)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/UpdateProfile", in, out)
}

func (c *userClient) UpdateProfileAndUserName(ctx context.Context, in *UserProfile, opts ...grpc.CallOption) (*CommonResponse, common.ErrorWithAttachment) {
	out := new(CommonResponse)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/UpdateProfileAndUserName", in, out)
}

func (c *userClient) StatisticCount(ctx context.Context, in *StatisticUserCountRequest, opts ...grpc.CallOption) (*StatisticCountResponse, common.ErrorWithAttachment) {
...
func _User_UpdateProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UpdateProfile(ctx, req.(*UserProfile))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_UpdateProfileAndUserName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserProfile)
	if err := dec(in); err != nil {
		return nil, err
	}
	...
	args := []interface{}{}
	args = append(args, in)
	invo := invocation.NewRPCInvocation("UpdateProfileAndUserName", args, nil)
	if interceptor == nil {
		result := base.XXX_GetProxyImpl().Invoke(ctx, invo)
		return result, result.Error()
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/usercenter.User/UpdateProfileAndUserName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UpdateProfileAndUserName(ctx, req.(*UserProfile))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_StatisticCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/usercenter.User/StatisticCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).StatisticCount(ctx, req.(*StatisticUserCountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
