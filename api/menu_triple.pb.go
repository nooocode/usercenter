...
type MenuClient interface {
	...
	GetAll(ctx context.Context, in *GetAllRequest, opts ...grpc_go.CallOption) (*GetAllMenuResponse, common.ErrorWithAttachment)
...
func (c *menuClient) GetAll(ctx context.Context, in *GetAllRequest, opts ...grpc_go.CallOption) (*GetAllMenuResponse, common.ErrorWithAttachment) {
